...
<section class="hero">
    ...
    <a class="btn btn-primary" href="user_produk.php">Jelajahi produk <i class="fa-solid fa-arrow-right" style="margin-left:8px"></i></a>
</section>
<section>
    <div class="section-head"><div><h2>Produk terbaru</h2><span>Pilihan yang tersedia hari ini</span></div><a class="muted" href="user_produk.php">Lihat semua <i class="fa-solid fa-arrow-right"></i></a></div>
    <div class="product-grid">
    <?php while ($product = mysqli_fetch_assoc($products)): ?>
        <article class="product-card">
            <a href="user_produk_detail.php?id=<?= (int) $product['id_produk']; ?>"><img class="product-image" src="<?= e(user_image($product['gambar_produk'])); ?>" alt="<?= e($product['nama_produk']); ?>"></a>
